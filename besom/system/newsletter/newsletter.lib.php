...
class newsletter {
	...
	public function newsletterTab () {
					...
					<div class="panel-body">
						...
						<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" class="form-horizontal" role="form">
							...
							<div class="form-group">
								...
								<button type="submit" name="submit" value="Hladaj" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-warning-sign"></i>&nbsp;Hladat</button>
		...
		elseif (isset($_GET['privacy'])AND $_GET['privacy'] != FALSE AND ($_GET['privacy'] == 'ASC' OR $_GET['privacy'] == 'DESC')) {
			$quer .= ' ORDER BY newsletter_privacy ' . $_GET['privacy'] . ' ';
		}
		...
		if ($query->num_rows != FALSE) {
			...
			<table class="table table-hover">
				<tr>
					<th>#</th>
					<th>Email 
						<a title="A-Z" href="<?php echo URL_ADRESA . '?menu=' . $_GET['menu'] . '&action=' . $_GET['action'] . '&title=DESC'; ?>">
							<span class="text-danger">↑</span>
						</a>
						<a title="Z-A" href="<?php echo URL_ADRESA . '?menu=' . $_GET['menu'] . '&action=' . $_GET['action'] . '&title=ASC'; ?>">
							<span class="text-danger">↓</span>
						</a>
					</th>
					<!-- <th>Popis</th>  -->
					<th>Datum 
						<a title="A-Z" href="<?php echo URL_ADRESA . '?menu=' . $_GET['menu'] . '&action=' . $_GET['action'] . '&tags=DESC'; ?>">
							<span class="text-danger">↑</span>
						</a>
						<a title="Z-A" href="<?php echo URL_ADRESA . '?menu=' . $_GET['menu'] . '&action=' . $_GET['action'] . '&tags=ASC'; ?>">
							<span class="text-danger">↓</span>
						</a>
					</th>
					<th>Token 
						<a title="A-Z" href="<?php echo URL_ADRESA . '?menu=' . $_GET['menu'] . '&action=' . $_GET['action'] . '&nav=DESC'; ?>">
							<span class="text-danger">↑</span>
						</a>
						<a title="Z-A" href="<?php echo URL_ADRESA . '?menu=' . $_GET['menu'] . '&action=' . $_GET['action'] . '&nav=ASC'; ?>">
							<span class="text-danger">↓</span>
						</a>
					</th>
					<th>Licencia 
						...
						<a title="min" href="<?php echo URL_ADRESA . '?menu=' . $_GET['menu'] . '&date=ASC'; ?>">
							<span class="text-danger">↓</span>
						</a>
					</th>
					<th>Stav 
						<a title="A-Z" href="<?php echo URL_ADRESA . '?menu=' . $_GET['menu'] . '&action=' . $_GET['action'] . '&author=DESC'; ?>">
							<span class="text-danger">↑</span>
						</a>
						<a title="Z-A" href="<?php echo URL_ADRESA . '?menu=' . $_GET['menu'] . '&action=' . $_GET['action'] . '&author=ASC'; ?>">
							<span class="text-danger">↓</span>
						</a>
					</th>
			...
			while ($news = $query->fetch_assoc()) {
				...
				<tr class="<?php echo htmlspecialchars($colorA[$text['text_public']]); ?>">
					...
					<td><?php echo htmlspecialchars($news['newsletter_token']); ?></td>
					<td><?php echo htmlspecialchars($news['newsletter_privacy']); ?></td>
					<td><?php echo htmlspecialchars($publikA[$news['newsletter_stav']]); ?></td>
					<td>
							<?php
	...
	public function pagesNew () {
		...
		# POST
		if (isset($_POST['submit']) AND isset($_POST['nazov']) AND isset($_POST['popis']) AND isset($_POST['text']) AND isset($_POST['menu'])) {
			...
			if (!empty($nazov) AND !empty($popis) AND !empty($text) AND !empty($menu) ) {
