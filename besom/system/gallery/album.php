...
if (isset($_GET['deactive']) AND $_GET['deactive'] != FALSE) {
	...
	$album->albumDeactive($_GET['deactive']);
...
# NADPIS
?><h2><?php echo htmlspecialchars($album->nadpis()); ?></h2><?php


# NEW TEXT LINK
?>
<a href="<?php echo URL_ADRESA . '?menu=' . $_GET['menu'] . '&action=' . $_GET['action'] . '&action1=new'; ?>"><h3>Vytvorit novy album <i class="glyphicon glyphicon-plus"></i></h3></a>
<?php
